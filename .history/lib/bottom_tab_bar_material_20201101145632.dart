import 'package:Sensorica/views/components/rotation_and_curl_drag.dart.bckp';
import 'package:Sensorica/views/components/rotation_and_curl_sensors.dart';
...
class BottomTabBarMaterial extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      children: [
        IconButton(
            ...
            onPressed: _index == 2
                ? null
                : () => Navigator.of(context).pushAndRemoveUntil(
                    MaterialPageRoute(builder: (context) => ViewRotationDrag()), (route) => false)),
        Text(
          'Drag',
          style: TextStyle(color: _index == 1 ? _disabledColor : _inactiveColor),
        ),
    ...
    _list = [rotationSensors, parallax, rotationDrag];
    return BottomAppBar(
