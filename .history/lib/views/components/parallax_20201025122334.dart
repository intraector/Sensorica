...
class _ParallaxState extends State<Parallax> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    print('---------- {widget.screenWidth} : ${widget.screenWidth}');
    print(
        '(WIDGET.SCREENWIDTH * (1 - MATRIX2SCALE): ${(widget.screenWidth * (1 - matrix2Scale)) / 2}');
    matrix2Origin = Matrix4.identity()..scale(matrix2Scale, matrix2Scale, 0.0);
    // ..translate(125, 125, 0);
