...
class _ParallaxState extends State<Parallax> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    ySlideAmount = widget.mediaQuery.size.width * 0.2;
    listen();
  }
...
//-------------------------------------
  void slideY() {
    ...
    ySlideOffset = Offset(0.0, offset * ySlideAmount);
  }
  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      ...
      AnimatedContainer(
          ...
          transform: Transform.translate(offset: ySlideOffset).transform,
          color: Colors.yellow,
