...
//-------------------------------------s
  void slide() {
    ...
    xOffset = (xOffset / 10).clamp(-10.0, 10.0);
    // print('XOFFSET: ${xOffset}');
    slideOffset = Offset(xOffset * slideAmount, (((yOffset + 0.5) * slideAmount)));
  }
  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      ...
      AnimatedContainer(
          ...
          // color: Colors.yellow,
          child: Transform(
            transform: Transform.translate(offset: Offset(0.0, -25.0)).transform,
