              ...
              GestureDetector(
                            ...
                            builder: (BuildContext context, Widget child) {
                              ...
                              return PhotoView(
                                  ...
                                  imageProvider: AssetImage(
                                    'assets/brush1000Bmp/output${_animationCurl.value.toString().padLeft(3, '0')}.bmp',
                                  ));
                            },
                          ),
                        ),
                  ...
                  onVerticalDragUpdate: (drag) {
                    ...
                    if (count > 10) {
                      ...
                      var newValue = (_controllerCurl.value + -(shift / 20)).clamp(0.0, 10.0);
                      // var newValue =
                      // (_controllerCurl.value + -(drag.delta.dy / 20)).clamp(0.0, 10.0);
