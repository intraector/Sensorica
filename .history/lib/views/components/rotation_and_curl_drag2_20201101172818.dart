...
class ViewRotationDrag2 extends StatefulWidget {
  ViewRotationDrag2({Key key}) : super(key: key);

  @override
  _ViewRotationDrag2State createState() => _ViewRotationDrag2State();
}

const int _xAmount = 5;

class _ViewRotationDrag2State extends State<ViewRotationDrag2> with TickerProviderStateMixin {
            ...
            children: [
              ...
              Flexible(
                child: Padding(
                  ...
                  child: Text(key, style: TextStyle(fontSize: 16, color: Colors.green)),
                ),
              ),
            ],
          ),
...
Map<String, String> paths = {
  ...
  '1000x563 (HD) BMP 309Mb': 'brush1000Bmp',
  '1280x720 (HD) 1.7Mb': 'brush1280',
  '1280x720 (HD) BMP 504Mb': 'brush1280Bmp',
  '1920x1080 (FullHD) 3.4Mb': 'brush1920',
  '2048x1152 (2k) 3.8Mb': 'brush2048',
  '3840x2160 (4k) 11.3Mb': 'brush3840',
};
