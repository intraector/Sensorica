...
class _ViewRotationDragState extends State<ViewRotationDrag> with TickerProviderStateMixin {
                              ...
                              child: Center(
                                child: AnimatedBuilder(
                                  ...
                                  builder: (BuildContext context, Widget child) {
                                    int frame = _animationCurl.value;
                                    // return PhotoView(
                                    //     maxScale: 1.0,
                                    ...
                                    //     ));
                                    return Image.memory(snapshot.data[frame],
                                        gaplessPlayback: true);
                                  },
                                ),
                              ),
  ...
  Future<List<Uint8List>> loadImages() async {
    ...
    for (int index = 1; index <= 182; index++) {
      futures.add(rootBundle.load('assets/brush4k/output${index.toString().padLeft(3, '0')}.png')
    ...
    images = uint8List.map((e) => Image.memory(e, gaplessPlayback: true));
    return uint8List;
  }
}
