              ...
              GestureDetector(
                            ...
                            builder: (BuildContext context, Widget child) {
                              ...
                              return PhotoView(
                                  ...
                                  imageProvider: AssetImage(
                                    'assets/brush800/output${_animationCurl.value.toString().padLeft(3, '0')}.jpg',
                                  ));
                            },
                          ),
                        ),
                  ...
                  onVerticalDragUpdate: (drag) {
                    ...
                    if (count > 10) {
                      ...
                      var newValue = _controllerCurl.value + -(angle / 10);
                      if (newValue < 0.0) {
                        newValue += 1;
                        _controllerCurl..animateTo(0.0)..animateTo(newValue);
                      } else if (newValue > 1.0) {
                        newValue -= 1.0;
                        _controllerCurl..animateTo(1.0)..animateTo(newValue);
                      } else {
