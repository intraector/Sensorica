...
class _ViewSecondState extends State<ViewSecond> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    //   precacheImage(AssetImage('assets/brush2k/output$frame.png'), context, onError: (e, _) {
    //     print('---------- e : $e');
    //   });
    // }
  ...
  void didChangeDependencies() {
    ...
    for (int i = 1; i <= 181; i++) {
      String frame = i.toString().padLeft(3, '0');
      precacheImage(AssetImage('assets/brushLow/output$frame.png'), context, onError: (e, _) {
        print('---------- e : $e');
      });
    }
  }
